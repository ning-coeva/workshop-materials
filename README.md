...
1. **Cognitive Rhythm as an Oversight Interface: Stop Rubber-Stamping through State-Aware Interaction**  
   Accepted contribution to the **AI CHAOS! Workshop, CHI 2026**.  
   [PDF](papers/CHI2026_AI_CHAOS_Cognitive_Rhythm_Oversight.pdf)
...
Contact: coevaxlumen.log@gmail.com

## Note

The AI CHAOS! PDF is an author-prepared archival copy reproducing the substantive text submitted through the workshop's Google Form. The Cognitive Personal Informatics PDF is the submitted workshop paper.
